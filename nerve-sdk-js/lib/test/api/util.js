...
module.exports = {
  ...
  async getBalance(chainId, assetChainId = 5, assetId = 1, address) {
    return await http.postComplete('/', 'getAccountBalance', [chainId, assetChainId, assetId, address]).then(response => {
  ...
  async getContractConstructor(contractCodeHex) {
    return await http.post('/', 'getContractConstructor', [contractCodeHex]).then(response => {
      //console.log(response);
  ...
  async getContractMethodArgsTypes(contractAddress, methodName, methodDesc) {
    return await http.post('/', 'getContractMethodArgsTypes', [contractAddress, methodName, methodDesc]).then(response => {
      if (response.hasOwnProperty("result")) {
        return { success: true, data: response.result };
      } else {
        return { success: false, data: response.error };
  ...
  async validateContractCreate(sender, gasLimit, price, contractCode, args) {
    return await http.post('/', 'validateContractCreate', [sender, gasLimit, price, contractCode, args]).then(response => {
  ...
  async imputedContractCreateGas(sender, contractCode, args) {
    return await http.post('/', 'imputedContractCreateGas', [sender, contractCode, args]).then(response => {
      //console.log(response);
      if (response.hasOwnProperty("result")) {
  ...
  async validateContractCall(sender, value, gasLimit, price, contractAddress, methodName, methodDesc, args) {
    return await http.post('/', 'validateContractCall', [sender, value, gasLimit, price, contractAddress, methodName, methodDesc, args]).then(response => {
      if (response.hasOwnProperty("result")) {
        return { success: true, data: response.result };
      } else {
        return { success: false, data: response.error };
  ...
  async imputedContractCallGas(sender, value, contractAddress, methodName, methodDesc, args) {
    return await http.post('/', 'imputedContractCallGas', [sender, value, contractAddress, methodName, methodDesc, args]).then(response => {
      if (response.hasOwnProperty("result")) {
        return { success: true, data: response.result };
      } else {
        return { success: false, data: response.error };
  ...
  async validateContractDelete(sender, contractAddress) {
    return await http.post('/', 'validateContractDelete', [sender, contractAddress]).then(response => {
      if (response.hasOwnProperty("result")) {
        return { success: true, data: response.result };
      } else {
        return { success: false, data: response.error };
  ...
  async validateTx(txHex) {
    return await http.post('/', 'validateTx', [txHex]).then(response => {
      //console.log(response);
      if (response.hasOwnProperty("result")) {
        return { success: true, data: response.result };
      } else {
  ...
  async getAllAddressPrefix() {
    return await http.post('/', 'getAllAddressPrefix', []).then(response => {
      console.log(response);
      if (response.hasOwnProperty("result")) {
        let data = {};
  ...
  async broadcastTx(txHex) {
    return await http.post('/', 'broadcastTx', [txHex]).then(response => {
      if (response.hasOwnProperty("result")) {
        return response.result;
      } else {
  ...
  async sendCrossTx(txHex) {
    return await http.post('/', 'sendCrossTx', [8, txHex]).then(response => {
      console.log(response);
      return response.result;
    }).catch(error => {
      return { success: false, data: error };
  ...
  async getConsensusNode(agentHash) {
    return await http.post('/', 'getConsensusNode', [agentHash]).then(response => {
      if (response.hasOwnProperty('result')) {
        return { success: true, data: response.result };
      } else {
