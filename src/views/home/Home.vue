    ...
    <div class="footer cb w1200">
      ...
      <div class="cb">
        <el-table :data="accountList" stripe class="tabs">
          ...
          <el-table-column prop="number" :label="$t('tab.tab37')" width="160" align="center">
          </el-table-column>
          ...
          <el-table-column :label="$t('nodeService.nodeService6')" min-width="200" align="center">
            <template slot-scope="scope">
              ...
              <el-button @click="crossLink(scope.row)" type="text" size="small" :disabled="!scope.row.isAcross">
                {{$t('home.home4')}}
              </el-button>
